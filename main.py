...
class Dlib_Face_Unlock:
    ...
    def __init__(self):
        ...
        try:
            ...
            with open(r'/home/ibrahim/PycharmProjects/YüzTanıma_sys/labels.pickle', 'rb') as self.f:
        ...
        if self.labels_ids != self.og_labels:
            ...
            with open(r'/home/ibrahim/PycharmProjects/YüzTanıma_sys/KnownFace.pickle', 'rb') as self.faces_file:
...
tk.Label(loginFrame, text="WELCOME!!", font=("Courier", 60), bg="white").grid(row=1, column=1, columnspan=5)
loginButton = tk.Button(loginFrame, text="Login", bg="#567", font=("Arial", 30), command=login)
loginButton.grid(row=2, column=5)
regButton = tk.Button(loginFrame, text="Register", command=regFrameRaiseFrame, bg="#567", font=("Arial", 30))
